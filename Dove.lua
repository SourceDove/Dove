...
Dev_Rio(msg.chat_id_, msg.id_, 1, '⌔︰العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'EEPEF')..')'..' ❩\n⌔︰تم رفعه ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
...
if mrrio == "مميز" and VipMem(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '⌔︰العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'EEPEF')..')'..' ❩\n⌔︰تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local Msg = DevRio:get(Dove..'Rio:Msg')
local Text = [[
...
DevRio:del(Dove..'Rio:EditMsg'..data.chat_id_..data.sender_user_id_)
...
DevRio:del(Dove..'Rio:UsersMsgs'..data.chat_id_..':'..data.sender_user_id_)
...
Dev_Rio(msg.sender_user_id_, msg.id_, 1, '⌔︰تم ارسال رسالتك الى [المطور](t.me/'..(chat.username_ or "EEPEF")..')', 1, 'md') 
...
--     Dove Source     --
if text == "مسح سحكاتي" or text == "مسح رسائلي" or text == "حذف رسائلي" or text == "حذف رسائلي" then
local Msg = DevRio:get(Dove..'Rio:Msg')
local Text = [[
⌔︰من خلال الازرار يمكنك مسح رسائلك وسحكاتك
]] 
...
local Text ='*⌔︰تم اختيار المقطع الصوتي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌔",callback_data="/Song:"..msg.sender_user_id_}},{{text = '⌔ Dove Source .',url="t.me/EEPEF"}}} 
local msg_id = msg.id_/2097152/0.5 
...
ConstructorRio = "["..Rio.first_name_.."](T.me/"..(Rio.username_ or "EEPEF")..")"
else 
