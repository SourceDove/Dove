...
{{text = '⌔ Delete facebook',url="https://www.facebook.com/help/deleteaccount"},{text = '⌔ Delete instagram',url="https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent"}},{{text= '⌔ Dove Source',url="https://t.me/EEPEF"}}
}
